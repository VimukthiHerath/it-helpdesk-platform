...
{
    private const string ConsumerGroupId = "assignment-workers";
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _logger.LogInformation(
            "Assignment consumer started. Topic={Topic}, GroupId={GroupId}, BootstrapServers={BootstrapServers}",
            topic,
            ConsumerGroupId,
            bootstrapServers);
        ...
        {
            _logger.LogInformation(
                "Assignment Kafka consumer is shutting down.");
        }
        finally
        {
            consumer.Close();
